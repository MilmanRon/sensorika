...
disclosures:
  heading: ארבע החבילות
  items:
    - title: חבילה 1. אבחון + תוכנית עבודה ביתית
      price:
        - label: השלב הראשון
          amount: 1,300 ₪
        - label: כל חודש נוסף
      ...
      sections:
        - body:
            - >-
              התוכנית מיועדת לשיתוף פעולה ארוך טווח — למשך הזמן הנדרש לילד.

        - heading: "השלב הראשון כולל:"
          items:
            - אבחון פרטני
            - בניית תוכנית אישית לעבודה ביתית לחודש הראשון
            - הנחיות מפורטות לביצוע המשימות
            - ייעוץ וליווי שבועי באמצעות WhatsApp

        - body:
            - >-
              לאחר האבחון המשפחה מקבלת תוכנית אישית ועובדת עם הילד בבית, תוך שמירה על קשר קבוע עם המטפל.

        - heading: "כל חודש נוסף כולל:"
          items:
            - מפגש טיפולי פרטני אחד
            - הערכת ההתקדמות של הילד
            - התאמת התוכנית בהתאם לתוצאות שהושגו
            - תוכנית חדשה לעבודה ביתית לחודש הבא
            - ליווי שבועי באמצעות WhatsApp

        - body:
            - >-
              משך שיתוף הפעולה אינו מוגבל מראש. אנחנו ממשיכים בעבודה כל עוד הדבר נדרש לילד, תוך הערכה שוטפת של התקדמותו והתאמת התוכנית לצרכיו העדכניים.

    - title: חבילה 2. אבחון + טיפול פרטני קבוע בקליניקה
      price:
        - label: 3 החודשים הראשונים
          amount: 3,400 ₪
        - label: כל חודש נוסף
          amount: 800 ₪
      sections:
        - body:
            - >-
              התוכנית מיועדת לתקופה של 3 חודשים לפחות.

        - heading: "עלות שלושת החודשים הראשונים כוללת:"
          items:
            - אבחון פרטני
            - בניית תוכנית טיפול אישית
            - מפגשים טיפוליים פרטניים פעם בשבוע, באורך 45 דקות
            - מעקב שוטף אחר התקדמות הילד
            - התאמת התוכנית בהתאם להתקדמותו ולצרכיו העדכניים
            - משימות ביתיות קצרות במידת הצורך

        - body:
            - >-
              מספר המפגשים בחודש עשוי להשתנות בהתאם למספר השבועות באותו חודש. המחיר החודשי נשאר קבוע ואינו משתנה בהתאם למספר המפגשים.
            - >-
              לאחר שלושת החודשים הראשונים ניתן להמשיך בתוכנית. המשך התוכנית נקבע באופן אישי — בהתאם לצורכי הילד ולהתקדמותו.

    - title: חבילה 3. תוכנית פרטנית אינטנסיבית
      price:
        - label: 3 החודשים הראשונים
          amount: 4,600 ₪
        - label: כל חודש נוסף
      ...
      sections:
        - body:
            - >-
              התוכנית מיועדת לתקופה של 3 חודשים לפחות של עבודה אינטנסיבית וקבועה, וכוללת תדירות גבוהה יותר של מפגשים טיפוליים.

        - heading: "בעלות כלולים:"
          items:
            - אבחון פרטני
            - בניית תוכנית טיפול אישית
            - שני מפגשים טיפוליים פרטניים בשבוע, כל אחד באורך 45 דקות
            - מעקב שוטף אחר התקדמות הילד
            - התאמה שוטפת של התוכנית בהתאם להתקדמות ולצרכים העדכניים של הילד
            - משימות ביתיות קצרות במידת הצורך

        - body:
            - >-
              בבחירת התוכנית האינטנסיבית, העלות בפועל של מפגש טיפולי אחד היא 150 ₪ במקום 200 ₪ בתוכנית הכוללת מפגש אחד בשבוע.
            - >-
              מספר המפגשים בחודש עשוי להשתנות בהתאם למספר השבועות באותו חודש. המחיר החודשי נשאר קבוע ואינו משתנה בהתאם למספר המפגשים.
            - >-
              לאחר שלושת החודשים הראשונים ניתן להמשיך בתוכנית. המשך התוכנית נקבע באופן פרטני בהתאם לצורכי הילד ולהתקדמותו.

    - title: חבילה 4. הכנה פרטנית לפעילויות קבוצתיות
      price:
        - label: מפגש אחד בשבוע
          amount: 800 ₪ לחודש
        - label: 2 מפגשים בשבוע
          amount: 1,200 ₪ לחודש
      sections:
        - body:
            - >-
              זוהי תוכנית מיוחדת ללא אבחון, המיועדת להכנת הילד למסגרת קבוצתית.
            - >-
              בראש ובראשונה ניתן להציע אותה לילד שכבר התחיל להשתתף בפעילויות קבוצתיות, אך במהלך התהליך התברר שבשלב הנוכחי הוא זקוק להכנה פרטנית נוספת.
            - >-
              במקרה כזה אנחנו קובעים אילו קשיים בדיוק מונעים מהילד להשתתף באופן מלא בקבוצה, ומעבירים באופן זמני את הדגש לעבודה פרטנית.
            - >-
              ניתן לזקוף את העלות שלא נוצלה עבור הפעילויות הקבוצתיות לטובת ההכנה הפרטנית, בהתאם לכללי התוכנית.
            - >-
              עם זאת, ניתן לבחור בחבילה גם בנפרד — עבור ילד הזקוק להכנה לקראת השתלבות עתידית בקבוצה. אבחון נפרד אינו כלול במחיר החבילה.
            - >-
              המטרה היא לפתח דווקא את המיומנויות שעדיין חסרות לילד לצורך השתתפות מוצלחת בקבוצה: היכולת לפעול בהתאם למבנה הפעילות, להתמודד עם העומס, לבצע משימות באופן עצמאי יותר, לווסת את מצבו וליצור אינטראקציה עם ילדים אחרים.

        - heading: מפגש אחד בשבוע — 800 ₪ לחודש
          body:
            - >-
              4 מפגשים פרטניים בני 45 דקות. עלות מפגש אחד — 200 ₪.

        - heading: 2 מפגשים בשבוע — 1,200 ₪ לחודש
          body:
            - >-
              8 מפגשים פרטניים בני 45 דקות. עלות מפגש אחד — 150 ₪.

        - body:
            - >-
              משך ההכנה נקבע באופן פרטני. ברגע שהילד מוכן במידה מספקת למסגרת הקבוצתית, הוא יכול לחזור לפעילויות הקבוצתיות או להצטרף אליהן.
            - >-
              מטרת התוכנית אינה להשאיר את הילד במסגרת פרטנית, אלא לעזור לו להתכונן להשתתפות מוצלחת בקבוצה.

terms:
  heading: תנאי ההשתתפות
  intro: >-
    התנאים שלהלן חלים על כל ארבע החבילות.
  panels:
    - heading: אמצעי תשלום
      body:
        - >-
    ...
    - heading: שינוי החבילה שנבחרה
      body:
        - >-
          מעבר מחבילה פרטנית אחת לאחרת אפשרי מתחילת חודש תשלום חדש, בתיאום מראש עם המטפלת ובהתאם לזמינות בלוח הזמנים.
---
