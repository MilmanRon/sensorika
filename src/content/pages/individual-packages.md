  ...
  items:
    - title: חבילה 1. אבחון + תוכנית עבודה ביתית
      ...
      sections:
        ...
        - body:
            - >-
              לאחר האבחון המשפחה מקבלת תוכנית אישית ועובדת עם הילד בבית, תוך שמירה על קשר קבוע איתי.
    ...
    - title: חבילה 2. אבחון + טיפול פרטני קבוע בקליניקה
      ...
      sections:
        - body:
            - >-
              התוכנית מיועדת למינימום של 3 חודשים של עבודה קבועה.
        ...
        - body:
            - >-
              מספר המפגשים בחודש קלנדרי מסוים עשוי להשתנות. עלות החבילה אינה מחושבת מחדש בהתאם למספר השבועות בחודש.
            - >-
              לאחר שלושת החודשים הראשונים ניתן להמשיך בתוכנית. משך המשך העבודה נקבע באופן אישי — בהתאם לצורכי הילד ולהתקדמותו.
    ...
    - title: חבילה 3. תוכנית פרטנית אינטנסיבית
      ...
      sections:
        - body:
            - >-
              התוכנית מיועדת לפחות ל-3 חודשים של עבודה אינטנסיבית וקבועה, וכוללת תדירות גבוהה יותר של מפגשים טיפוליים.
        ...
        - body:
            ...
            - >-
              מספר המפגשים בחודש קלנדרי מסוים עשוי להשתנות. עלות החבילה אינה מחושבת מחדש בהתאם למספר השבועות בחודש.
            - >-
              לאחר שלושת החודשים הראשונים ניתן להמשיך בתוכנית. משך המשך העבודה נקבע באופן פרטני בהתאם לצורכי הילד ולהתקדמותו.
